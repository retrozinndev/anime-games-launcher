...
mod tests {
    ...
    fn get_values() -> [(&'static str, Vec<u8>); 24] {
        [
            ("crc32",           vec![208, 195, 74, 236]),
            ("crc32c",          vec![104, 16, 85, 77]),
            ("seahash",         vec![253, 6, 208, 102, 41, 87, 194, 46]),
            ("siphash-1-3-64",  vec![147, 39, 201, 56, 128, 161, 114, 41]),
            ("siphash-1-3-128", vec![191, 107, 239, 175, 162, 213, 193, 236, 169, 129, 231, 119, 6, 126, 238, 15]),
            ("siphash-2-4-64",  vec![31, 39, 10, 239, 52, 109, 73, 38]),
            ("siphash-2-4-128", vec![50, 170, 110, 242, 8, 65, 163, 227, 18, 89, 105, 46, 109, 105, 177, 5]),
            ("xxh32",           vec![80, 222, 7, 64]),
            ("xxh64",           vec![127, 228, 15, 8, 248, 172, 154, 196]),
            ("xxh3-64",         vec![170, 2, 102, 97, 95, 93, 65, 96]),
            ("xxh3-128",        vec![149, 83, 215, 44, 132, 3, 219, 119, 80, 221, 71, 68, 132, 242, 29, 83]),
